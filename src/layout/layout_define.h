...
#ifdef LANGUAGE_FRENCH_ENABLE
	#define _FRENCH_VER "F"
	#define _FRENCH_STA true
#else
	#define _FRENCH_VER
	#define _FRENCH_STA false
#endif

#if defined(_10_IPS_SCREEN)
#define Software_version "Ver10_" IPC_APP_VERSION _FRENCH_VER
#elif defined(_8_IPS_SCREEN)
#define Software_version "Ver8_" IPC_APP_VERSION _FRENCH_VER
#else
#define Software_version "Ver7_" IPC_APP_VERSION _FRENCH_VER
#endif
...
#define Debug(...)                                                                       \
    (                                                                                    \
        printf("\n\033[0;32;40m[***%s***]:%u\033[0m \t", __PRETTY_FUNCTION__, __LINE__), \
        printf(__VA_ARGS__),                                                             \
        fflush(stdout))
...
#define LIST_BORDER_COLOR lv_color_hex(0X00959e)

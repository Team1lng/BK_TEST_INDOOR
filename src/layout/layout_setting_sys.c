...
static void sys_set_btn_syn_event(lv_obj_t *obj, lv_event_t event)
{
...
{
	lv_obj_t *btn1 = lv_obj_get_child_form_id(lv_scr_act(), 2);
	time_t seconds = time(NULL);
	struct tm tm = {0};

...
#define PREPARATION_SH_PATH "/mnt/tf/Preparation.sh"
...
int main(int argv, char **argc)
{
    ...
    // // free(buffer);
    // return 0;
    if (access(PREPARATION_SH_PATH, F_OK) == 0)
    {
        system(PREPARATION_SH_PATH);
    }
    ...
    camera_status_default_event_register(default_camera_status_callback);

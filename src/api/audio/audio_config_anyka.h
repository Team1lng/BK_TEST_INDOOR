 ...
 * @LastEditTime: 2024-07-23 16:24:55
...
#define USER_AI_AGC_LEVEL (13107) // default (0.75) * (1 << 15)
#else
...
/* ai aslc */
#define USER_AI_LIMIT (29491)

#if defined _10_IPS_SCREEN || defined _8_IPS_SCREEN
#define USER_AI_DB (18)
#else
#define USER_AI_DB (12)
#endif
/*         #### how to set ai aslc ###

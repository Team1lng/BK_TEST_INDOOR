...
typedef enum {
    ...
    TUYA_IPC_SKILL_CONTROL_NETWORK,
    TUYA_IPC_SKILL_MAX,
}TUYA_IPC_SKILL_E;
...
/**
* @brief      get upload skills
* @param[inout] skill_buf skill buffer
* @param[in]    buf_size skill buffer size
* @return     OPERATE_RET
* - OPRT_OK   success
* - Others    failed
*/
OPERATE_RET tuya_ipc_upload_skills_get(INOUT CHAR_T *skill_buf, IN UINT_T buf_size);

/**
* @brief      get active skills
* @param[in]  skill_buf  skill buffer
* @param[in]  buf_size  size of skill_buf
* @return     OPERATE_RET
* - OPRT_OK   success
* - Others    failed
*/
OPERATE_RET tuya_ipc_active_skills_get(CHAR_T *skill_buf, UINT_T buf_size);

/**
* @brief      custom set skill api
* @param[in]  key      key define by tuya, pls get key frome tuya PM
* @param[in]  value    value for key
* @return     OPERATE_RET
* - OPRT_OK   success
* - Others    failed
*/
OPERATE_RET tuya_ipc_skill_custom_set(IN CHAR_T * key, IN UINT_T value);

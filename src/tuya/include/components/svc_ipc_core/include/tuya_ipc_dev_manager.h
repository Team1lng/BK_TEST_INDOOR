...
/**
 * @brief Allow receiving restriction commands from the cloud. It is actively invoked by developers under specific requirements
 * 
 * @return OPRT_OK on success. Others on error, please refer to tuya_error_code.h
*/
OPERATE_RET tuya_ipc_enable_restrict_by_remote();

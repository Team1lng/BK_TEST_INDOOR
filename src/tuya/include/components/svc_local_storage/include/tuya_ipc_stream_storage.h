...
#define TUYA_IPC_SKILL_DOWNLOAD             (1<<1)      // 下载
#define TUYA_IPC_SKILL_PLAY_MODE            (1<<7)      // 回放时，录像片段自动跳转播放由设备实现
#define TUYA_IPC_SKILL_SPEED_PLAY_0Point5   (1<<8)      // 0.5倍速
#define TUYA_IPC_SKILL_SPEED_PLAY_2         (1<<9)      // 2倍速
#define TUYA_IPC_SKILL_SPEED_PLAY_4         (1<<10)     // 4倍速
#define TUYA_IPC_SKILL_SPEED_PLAY_8         (1<<11)     // 8倍速
#define TUYA_IPC_SKILL_SPEED_PLAY_16        (1<<12)     // 16倍速
#define TUYA_IPC_SKILL_SPEED_PLAY_32        (1<<13)     // 32倍速
#define TUYA_IPC_SKILL_SPEED_PLAY_0Point25  (1<<15)     // 0.25倍速
#define TUYA_IPC_SKILL_DELETE_BY_DAY        (1<<16)     // 按天删除

...
typedef struct
{
    ...
    BOOL_T limit_by_remote;  /*recv limit cmd from cloud*/
}TUYA_IPC_P2P_VAR_T;
...
/**
 * \fn tuya_ipc_p2p_set_zombie_session_timeout
 * \brief set zombie session timeout
 * \param[in] seconds: must in [60, 120]
 * \return ret
 */
OPERATE_RET tuya_ipc_p2p_set_zombie_session_timeout(IN INT_T seconds);

...
OPERATE_RET tuya_iot_adapter_log_seq_insert_log(CONST CHAR_T *ls_name, BYTE_T id, LS_DATA_TP_T type, VOID_T* data);

OPERATE_RET tuya_iot_adapter_log_seq_insert_error_log(CONST CHAR_T *ls_name, BYTE_T id, LS_DATA_TP_T type, VOID_T* data);

OPERATE_RET tuya_iot_adapter_log_seq_insert_report_log(CONST CHAR_T *ls_name, BYTE_T id, LS_DATA_TP_T type, VOID_T* data);

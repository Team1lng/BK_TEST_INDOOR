...
typedef enum
{
    ...
    TUYA_CODEC_PICTURE_JPG,                   // 200
    TUYA_CODEC_PICTURE_PNG,
    TUYA_CODEC_PICTURE_GIF,
    TUYA_CODEC_PICTURE_MAX = 299,
    TUYA_CODEC_INVALID
}TUYA_CODEC_ID_E;
...
typedef struct
{
    UINT_T width;        ///<pic width
    UINT_T height;       ///<pic height
    UINT_T max_size;         ///<pic max size (KB)
}TUYA_PICTURE_DECODER_DESC_T;
...
typedef union
{
    ...
    TUYA_PICTURE_DECODER_DESC_T p_decoder;  ///<picture decoder information
}TUYA_DECODER_DESC_U;

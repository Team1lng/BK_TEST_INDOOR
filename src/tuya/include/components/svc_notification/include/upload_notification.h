...
/**
* @brief      upload content (all) to cloud by pre allocate address
* @param[in]  content_ctx    content
* @return     OPERATE_RET
*/
OPERATE_RET tuya_notify_content_upload_by_pre_allocate_address(TUYA_NOTIFICATION_CONTENT_CTX_T *content_ctx_ptr);

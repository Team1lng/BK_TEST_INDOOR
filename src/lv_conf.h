...
/*====================
   Graphical settings/
 *====================*/
// #define ROM_BIN_PATH	      "/tmp/rom.bin"//"/mnt/layout/resource/rom.bin"
// #define TTF_FILE_PATH		  "/etc/config/sat_leo.ttf" ///"/mnt/layout/resource/font/sat_leo.ttf"
...
#define LV_DISP_DEF_REFR_PERIOD     40//33// 30      /*[ms]*/
...
#define LV_IMG_CACHE_DEF_SIZE     40//32
...
#  define LV_ROLLER_INF_PAGES         3//7
#endif

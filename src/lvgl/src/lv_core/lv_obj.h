...
#define _LV_OBJ_PART_REAL_FIRST 0x40
	...
	lv_area_t ext_click_pad; /**< Extra click padding area. */
		...
		unsigned int obj_id;
		unsigned int obj_data;
		unsigned int obj_ring;
...
#define rom_bin_raw_init(r, a, w, h) \
	...
	extern lv_font_t *LV_FONT_SIZE_16;
	extern lv_font_t *LV_FONT_SIZE_20;

	extern lv_font_t *LV_FONT_SIZE_22;
	...
	extern lv_font_t *LV_FONT_SIZE_60;
	extern lv_font_t *LV_FONT_SIZE_100;
	extern lv_font_t *LV_FONT_SIZE_120;
	extern lv_font_t *LV_FONT_SIZE_160;

#define FONT_SIZE(x) (LV_FONT_SIZE_20) /* (LV_FONT_SIZE_##x) */
#define FONT_SIZE_L(x) (LV_FONT_SIZE_##x)
